...
Для массивов и вложенных объектов предусмотрено указание типа элемента и целевой
модели. Заданные параметры применяются репозиторием для проверки документов
перед сохранением.
