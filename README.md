...
с дополнительными параметрами. В контексте реляционных баз данных свойства
отражают колонки таблицы.
...
Для массивов и вложенных объектов предусмотрено указание типа элементов или
целевых моделей. Заданные параметры применяются репозиторием для валидации
и подготовки документов перед сохранением.
