...
ORM/ODM библиотека, реализующая слой доступа к данным на основе паттерна
«Репозиторий». Унифицирует интерфейс различных источников данных, фильтрацию
и работу со связанными документами независимо от используемого хранилища.
